...
<div class="container">
    <h1>Nova Revisão</h1>
    <p class="lead">Registrar nova revisão</p>
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Registrar nova revisão</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('vistorias.store') }}">
